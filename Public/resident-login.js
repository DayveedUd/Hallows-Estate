// ================================================
// RESIDENT LOGIN - Frontend JavaScript
// ================================================
...
loginForm.addEventListener('submit', async function(e) {
    ...
    try {
        ...
        if (response.ok && data.success) {
            // Save token and resident info to localStorage
            ...
            localStorage.setItem('residentUnit', data.unit);
            
            // Redirect to resident portal after 500ms
            setTimeout(() => {
